...
import { Link } from 'react-router-dom';
import logo from '../assets/Social_Hire_page-0001-removebg-preview.png';
import Login from '../LoginComponent/Login.jsx'; // Import the Login component
import Signup from '../LoginComponent/SignUp.jsx'; // Import the SignUp component
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        ...
                        <ul className="navbar-nav ms-auto">
                            <li className="nav-item">
                                ...
                                <p><b><button className="nav-link text-white fs-6 text-center mx-3" onClick={toggleSignUp}>SignUp</button></b></p>
                                </div>
