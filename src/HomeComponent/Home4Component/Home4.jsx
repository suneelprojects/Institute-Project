...
<Link onClick={toggleLogin} className='bg-white text-dark btn-lg fs-6' style={{borderRadius:'25px',textDecoration:'none'}}>Apply Now <i className="bi bi-arrow-up-right ms-3"></i> </Link>
</div>
</div>
        </div>
