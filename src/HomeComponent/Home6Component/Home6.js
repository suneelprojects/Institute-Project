...
<Link to='/login' className='bg-white text-dark btn-lg fs-6' style={{borderRadius:'25px',textDecoration:'none'}}>Build Your Resume <i className="bi bi-arrow-up-right ms-3"></i> </Link>
</div>
