...
const BookMentor = () => {
    ...
    const handleMentorClick = (mentorFor) => {
        setSelectedMentor(mentorFor); // Set the selected mentor
        // Scroll to the mentor profiles section
        if (mentorProfilesRef.current) {
            mentorProfilesRef.current.scrollIntoView({ behavior: 'smooth' });
        }
    ...
    return (
        <div style={{ marginTop: '150px' }} className='container-fluid'>
            <div className='row'>
                ...
                <div className='col-12 col-md-6'>
                    <img src='https://img.freepik.com/free-vector/man-woman-touching-each-other-when-work-is-done_1150-35029.jpg?t=st=1736679593~exp=1736683193~hmac=e5b6e7a787f628607f1a3c57df163f0fcc27300b3f084174a785878ff3a2febb&w=1380' style={{ height: '100%', width: '100%' }} alt="Mentors"></img>
                </div>
            </div>
