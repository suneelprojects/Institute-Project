...
// import { auth } from '../services/firebaseConfig.js'; // Ensure correct import for Firebase auth
...
//             <ul className="navbar-nav mx-auto">
//               <li className="nav-item">
//                 <h5><Link className={`nav-link ${navBarStyle.navlink} ${navBarStyle.navbarCenter} text-white`} to='/'>Curated Jobs</Link></h5>
//               </li>
//               <li className="nav-item">
//                 <h5><a href='https://socialhire.in/resume-checker/' style={{ textDecoration: 'none' }} className={`nav-link ${navBarStyle.navlink} ${navBarStyle.navbarCenter} mx-2  text-white`}>Resume Checker</a></h5>
//               </li>
//               <li className="nav-item">
//                 <h5><Link className={`nav-link ${navBarStyle.navlink} ${navBarStyle.navbarCenter} mx-2  text-white`} to='/bookmentor'>Book Mentor</Link></h5>
//               </li>
//               <li className="nav-item">
//                 <h5><Link className={`nav-link ${navBarStyle.navlink} ${navBarStyle.navbarCenter} mx-2  text-white`} to='/placement'>Placement Preparation</Link></h5>
//               </li>
//               {/* <li className="nav-item">
//                 <h5><Link className={`nav-link ${navBarStyle.navlink} ${navBarStyle.navbarCenter} mx-2`} to='/userProfile'>userProfile</Link></h5>
//               </li> */}
        ...
        <div className="container-fluid d-flex justify-content-between align-items-center">
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav mx-auto">
              ...
              <li className="nav-item">
                <h5><a href='https://socialhire.in/resume-checker/' style={{ textDecoration: 'none' }} className={`nav-link ${navBarStyle.navlink} ${navBarStyle.navbarCenter} mx-2  text-white`} onClick={handleNavLinkClick}>Resume Checker</a></h5>
              </li>
              <li className="nav-item">
              ...
              {/* <li className="nav-item">
                <h5><Link className={`nav-link ${navBarStyle.navlink} ${navBarStyle.navbarCenter} mx-2`} to='/userProfile' onClick={handleNavLinkClick}>userProfile</Link></h5>
              </li> */}
            </ul>
